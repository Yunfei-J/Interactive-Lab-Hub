...
* "Looks like": Chord bot has a body made from a juice box and wrapped in aluminum foil. Inside the body is where we hid the webcam. Chord bot also has a aluminumfoil-made head with a smiley face. The distance is reflected real-time on the MiniPiTFT.
